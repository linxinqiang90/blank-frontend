...
const localeInfo = {
  'en-US': {
    messages: require('/home/git/blank-frontend/src/locales/en-US.js').default,
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: require('/home/git/blank-frontend/src/locales/pt-BR.js').default,
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: require('/home/git/blank-frontend/src/locales/zh-CN.js').default,
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: require('/home/git/blank-frontend/src/locales/zh-TW.js').default,
    locale: 'zh-TW',
