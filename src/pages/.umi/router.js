...
let routes = [
  {
    ...
    "routes": [
      ...
      {
        "component": () => React.createElement(require('/home/git/blank-frontend/node_modules/_umi-build-dev@1.2.6@umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'src/pages', hasRoutesInConfig: true })
      }
    ]
  },
  {
